...
(est = mme4(y, X, Z, Z, A[321:499, 321:499], G, 0.02629626, 0.00842668, 179)$est)


C = as.matrix(mme4(y, X, Z, Z, A[321:499, 321:499], G, 0.02629626, 0.008426684, 179)$C)
invC = ginv(C)

invC22 = invC[19:198, 19:198]
(r2 = diag(1 - invC22*(0.008426684/0.02629626)))
r2[r2 < 0] = 0
(r = sqrt(r2))
